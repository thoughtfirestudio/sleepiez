-- Seed 6 weeks of pre-draft challenges (v2: pop culture edition)
DELETE FROM challenge_submissions;
DELETE FROM challenges;

-- Week 1 (Jul 9-16): 2010s Pop & Indie
...
]'::jsonb, '2026-07-09T00:00:00Z', '2026-07-16T00:00:00Z');

-- Week 2 (Jul 16-23): Movie Trivia
...
]'::jsonb, '2026-07-16T00:00:00Z', '2026-07-23T00:00:00Z');

-- Week 3 (Jul 23-30): Breaking Bad
...
]'::jsonb, '2026-07-23T00:00:00Z', '2026-07-30T00:00:00Z');

-- Week 4 (Jul 30 - Aug 6): Lord of the Rings
...
]'::jsonb, '2026-07-30T00:00:00Z', '2026-08-06T00:00:00Z');

-- Week 5 (Aug 6-13): Star Wars
...
]'::jsonb, '2026-08-06T00:00:00Z', '2026-08-13T00:00:00Z');

-- Week 6 (Aug 13-20): EDM & Festival Culture
...
]'::jsonb, '2026-08-13T00:00:00Z', '2026-08-20T00:00:00Z');
